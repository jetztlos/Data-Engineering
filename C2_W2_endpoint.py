        ...
        while request_url:
            ...
            if response.status_code == 401:  # Unauthorized
                ...
                if "access_token" in token_response:
                    headers = get_auth_header(access_token=access_token["access_token"])
    ...
    **kwargs,
    ...
    try:
        while request_url:
            ...
            album_data.extend(response_json["album_data"]["items"])
            # Update request_url with the "next" value from response_json.
            request_url = response_json["album_data"]["next"]
