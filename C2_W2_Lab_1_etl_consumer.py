                ...
                for record in records_response["Records"]:
                    ...
                    try:
                        ...
                        for product in user_session["browse_history"]:
                            ...
                            overall_product_quantity += int(quantity["quantity"])

                            # Instructions are in the step 2.2.6.
                            if product["in_shopping_cart"] == True:
                                overall_in_shopping_cart += int(quantity["quantity"]) 

                        # Instructions are in the step 2.2.7.
                        user_session["overall_product_quantity"] = overall_product_quantity
                        user_session["overall_in_shopping_cart"] = overall_in_shopping_cart

                        user_session["total_different_products"] = len(user_session["browse_history"])
